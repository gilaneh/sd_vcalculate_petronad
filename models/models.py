...
class SdVcalculatePetronad(models.Model):
    _name = 'sd_vcalculate_petronad.data'
...
class SdVcalculateDataPetronad(models.Model):
    _inherit = 'sd_vcalculate.data'

    def calculate(self, function_name, diagram_id):
        res = super(SdVcalculateDataPetronad, self).calculate(function_name, diagram_id)
